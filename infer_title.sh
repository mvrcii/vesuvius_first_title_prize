...
CKPT_PATH="checkpoints/warm-planet-193-unetr-sf-b3-250417-171532/best-checkpoint-epoch=13-val_iou=0.71.ckpt"
START_LAYER_IDX=0
END_lAYER_IDX=5
TTA_LEVEL=3
STRIDE=4
...
python scripts/inference.py "$FRAGMENT_CHUNK_PATH" "$CKPT_PATH" --start_layer "$START_LAYER_IDX" --end_layer "$START_LAYER_IDX" --tta "$TTA_LEVEL" --stride "$STRIDE" --title_crop
